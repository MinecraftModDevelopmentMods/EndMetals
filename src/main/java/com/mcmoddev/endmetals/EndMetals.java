 ...
 *
 */
@Mod(modid = EndMetals.MODID, name = EndMetals.NAME, version = EndMetals.VERSION, dependencies = "required-after:Forge;after:modularity;after:modernmetals;after:basemetals", acceptedMinecraftVersions = "[1.10.2,)", updateJSON = "https://raw.githubusercontent.com/MinecraftModDevelopment/EndMetals/master/update.json")
